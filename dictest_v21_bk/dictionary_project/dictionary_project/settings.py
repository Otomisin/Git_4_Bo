...
SECRET_KEY = 'django-insecure-qg!+hb%=+@il@$2r$y%@y_m2e+psdpr&h%i_m2s$(ih8gx0xh='
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'dictionary' / 'templates'],
        'APP_DIRS': True,  # Allow searching in app-specific templates directories
        'OPTIONS': {
            'context_processors': [
